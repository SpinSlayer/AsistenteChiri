...
const renderizarCalendario = () => {
    ...
    document.querySelector('.date h1').innerHTML = ArrMeses[fecha.getMonth()] + " " + fecha.getFullYear().toString()

    
    //especifica el dia del mes, semana y mes de la fecha actual en la cabecera del calendario
    var paramFecha = {weekday: "long", year: "numeric", month: "long", day: "numeric"};
    document.querySelector('.date p').innerHTML = new Date().toLocaleDateString("es-ES",paramFecha)
